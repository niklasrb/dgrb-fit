...
int main(int argc, char** argv)
{
	...
	B.AstrophysicalSources.push_back(std::make_shared<FSRQ>(CM));
	B.AstrophysicalSources.push_back(std::make_shared<BLLAC>(CM));
	//B.AstrophysicalSources.push_back(std::make_shared<SFG>(CM));
